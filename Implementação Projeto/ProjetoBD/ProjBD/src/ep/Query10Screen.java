...
public class Query10Screen extends Screen{
	private static final long serialVersionUID = 1L;
	
	private JTable table;
    private DefaultTableModel tableModel;
	
	public Query10Screen() {
		super("Query 10");
		addComponents();
	}
	...
	protected void addComponents() { //Cria o layout da página
		...
		btnSubmit.addActionListener(e -> {
		    try {
			        ...
			        DefaultTableModel resultModel = consultas.query10();
        ...
        tableModel = new DefaultTableModel(new Object[]{"nomeEmpresa", "faturamento"}, 0);
