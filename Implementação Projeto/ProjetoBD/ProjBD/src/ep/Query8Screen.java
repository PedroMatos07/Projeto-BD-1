...
public class Query8Screen extends Screen{
	...
	protected void addComponents() { //Cria o layout da página
		...
		btnSubmit.addActionListener(e -> {
		    try {
			        ...
			        DefaultTableModel resultModel = consultas.query8();
        ...
        tableModel = new DefaultTableModel(new Object[]{"nomeCidade", "numSolicitacoes"}, 0);
