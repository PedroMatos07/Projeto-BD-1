...
public class Query4Screen extends Screen{
	...
	protected void addComponents() { //Cria o layout da página
		...
		btnSubmit.addActionListener(e -> {
		    try {
			        ...
			        DefaultTableModel resultModel = consultas.query4();
        ...
        tableModel = new DefaultTableModel(new Object[]{"idPedido", "nomeCliente", "enderecoPartida", "enderecoDestino", "precoTotal"}, 0);
