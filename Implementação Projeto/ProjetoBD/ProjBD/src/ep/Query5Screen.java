...
public class Query5Screen extends Screen{
	...
	protected void addComponents() { //Cria o layout da página
		...
		year = createTextField(1, 1, GridBagConstraints.WEST, "Ano:");
		
		JButton btnSubmit = createButton(2, 1, GridBagConstraints.CENTER, "Consultar");
		btnSubmit.addActionListener(e -> {
		    try {
			        Consultas consultas = new Consultas();
			        DefaultTableModel resultModel = consultas.query5(Integer.parseInt(year.getText()));
        ...
        tableModel = new DefaultTableModel(new Object[]{"nomeEmpresa", "mes", "faturamento"}, 0);
