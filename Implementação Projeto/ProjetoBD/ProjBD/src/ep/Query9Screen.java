...
public class Query9Screen extends Screen{
	...
	protected void addComponents() { //Cria o layout da página
		...
		btnSubmit.addActionListener(e -> {
		    try {
			        ...
			        DefaultTableModel resultModel = consultas.query9();
        ...
        tableModel = new DefaultTableModel(new Object[]{"nomeCidade", "quantPedidos"}, 0);
