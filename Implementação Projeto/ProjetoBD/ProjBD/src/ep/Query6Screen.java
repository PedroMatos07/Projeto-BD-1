...
public class Query6Screen extends Screen{
	...
	protected void addComponents() { //Cria o layout da página
		...
		btnSubmit.addActionListener(e -> {
		    try {
			        ...
			        DefaultTableModel resultModel = consultas.query6();
        ...
        tableModel = new DefaultTableModel(new Object[]{"servTipo", "totalSolicitacoes"}, 0);
